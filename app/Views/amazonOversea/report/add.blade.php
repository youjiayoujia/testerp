<div class='row'>
    ...
    <div class='form-group col-sm-2'>
        <input type='text' class='form-control report_quantity' id='arr[report_quantity][{{$current}}]' placeholder='数量' name='arr[report_quantity][{{$current}}]' value={{ old('arr[report_quantity][$current]') }}>
    </div>
