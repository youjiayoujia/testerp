...
<div class="main">
    <div class="header1">
        ...
        <div style="height:23mm;margin-top:5px;">
            ...
            <div style="width:210px;height:80px;margin-right:13px;float:right;text-align:center;line-height:17px;"><p style="font-size:14px;font-weight:bold;">PREPAID</p>
                <p style="font-size:13px;">Germany</p>
                <p style="font-size:12px;">Postfach 2007</p>
                <p style="font-size:12px;">36243 Niederauls</p></div>
