            ...
            <div class="row">
                ...
                <div class="form-group col-lg-1">
                    ...
                    <select class="form-control" name="sync_days">
                        @for($i=1;$i<31;$i++)
                            <option value="{{ $i }}" {{ Tool::isSelected('sync_days', $i) }}>{{ $i }}</option>
                        @endfor
                    </select>
                </div>
                <div class="form-group col-lg-1">
                    ...
                    <select class="form-control" name="sync_pages">
                        @for($i=100;$i>0;$i-=10)
                            <option value="{{ $i }}" {{ Tool::isSelected('sync_pages', $i) }}>{{ $i }}</option>
                        @endfor
                    </select>
                </div>
                <div class="form-group col-lg-1">
                ...
                <div class="form-group col-lg-1">
                    ...
                    <select class="form-control" name="catalog_rates_channel_id">
                        @foreach($catalog_rates_channels as $catalog_rates_channel)
                            <option value="{{ $catalog_rates_channel->id }}">{{ $catalog_rates_channel->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
