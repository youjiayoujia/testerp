    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class='row'>
                ...
                <div class='col-lg-2'><label>is_tonanjing</label></div>
            </div>
            @foreach($errors as $key => $value)
            @if($key != 0)
            <div class='row'>
                <div class='col-lg-2'><input type='text' class='form-control' value="{{ iconv('gb2312','utf-8',$errors[0][$value]['package_id']) }}"></div>
                <div class='col-lg-2'><input type='text' class='form-control' value="{{ iconv('gb2312','utf-8',$errors[0][$value]['is_tonanjing']) }}"></div>
            </div>
            @endif
            @endforeach
        </div>
