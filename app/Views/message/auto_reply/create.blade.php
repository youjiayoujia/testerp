...
@section('formBody')
    ...
    <div class='row'>
        <div class="form-group col-md-3">
            ...
            <input class="form-control" placeholder="中文自动回复规则描述" name='name' value="{{ old('name') }}">
        </div>
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <input class="form-control" placeholder="只允许添加必要的空格,多条用英文逗号隔开','" name='message_keywords' value="{{ old('message_keywords') }}">
        </div>
    </div>
{{--    <div class="row">
        <div class="form-group col-md-12">
            <label for="color">客服消息同时包括:</label>
            <input class="form-control" placeholder="只允许添加必要的空格,多条用英文逗号隔开','" name='reply_keywords' value="{{ old('reply_keywords') }}">
        </div>
    </div>--}}
    <div class="row">
        <div class="form-group col-md-12">
            <label for="color">主题中同时包括:</label>
            <input class="form-control" placeholder="只允许添加必要的空格,多条用英文逗号隔开','" name='label_keywords' value="{{ old('label_keywords') }}">
        </div>
    </div>
{{--    <div class="row">
        ...
        <div class="col-lg-5">
            <code for="name" class="control-label">平邮已发货</code>
        </div>
        <div class="col-lg-3">
            <input type="text" value="{{old('filter_start_time')}}" class="form-control datetime_select" name="filter_start_time" placeholder="开始时间">
        </div>
        <div class="col-lg-3">
            <input type="text" value="{{old('filter_end_time')}}" class="form-control datetime_select" name="filter_end_time" placeholder="结束时间">
        </div>
    </div>--}}
    <div class="row">
        <div class="form-group col-lg-1">
        ...
        <div class="col-lg-12" id="templateContent">
            <div class="form-group">
                <textarea class="form-control"  id="textcontent"
                          rows="16" name="template" style="width:100%;height:400px;">{{ old('template') ?  old('template') : ''}}</textarea>
            </div>
        </div>
    </div>
