...
Class.pt.creat = function(){
    ...
    if(config.title[1] && (config.type !== 3 || config.type !== 4)){
        ...
        switch(confbtn.btns){
            ...
            break;
            case 1:
                that.layerBtn.html('<a href="javascript:;" class="xubox_yes xubox_botton1 btn btn-sm btn-primary">'+ confbtn.btn[0] +'</a>');
            break;
            case 2:
                that.layerBtn.html('<a href="javascript:;" class="xubox_yes xubox_botton2 btn btn-sm btn-primary">'+ confbtn.btn[0] +'</a>' + '<a href="javascript:;" class="xubox_no xubox_botton3">'+ confbtn.btn[1] + '</a>');
            break;                
        }
    }
